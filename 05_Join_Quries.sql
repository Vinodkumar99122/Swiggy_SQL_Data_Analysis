/*-----------------------------------------------------------------------------------
	Script Name : 05_Join_Quries.sql
	Purpose     : Demonstrate JOIN quries using Swiggy dataset
...
--6. CROSS JOIN example(cartesian product of small offers table and first 10 restaurant)
